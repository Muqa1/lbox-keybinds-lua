...
local coloured_line = {255, 190, 94, 255} -- the coloured line
...
deafultFont = draw.CreateFont( "Tahoma", 14, 800 )
...
spectators_start_x = 10
spectators_start_y = 650
...
--============================--
    ...
    draw.Text(math.floor(keybinds_start_x) + 30, math.floor(keybinds_start_y) + 2, "keybinds")
...
if input.IsButtonDown(MOUSE_LEFT) and -- is the cursor inside the box?
    ...
    draw.SetFont( deafultFont ) -- drawing the keybinds text
    draw.Color(table.unpack(keybinds_color))
    draw.Text(math.floor(spectators_start_x) + 25, math.floor(spectators_start_y) + 2, "spectators")
